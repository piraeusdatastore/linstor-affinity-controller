...
- Updated golinstor to enable automatic certificate rotation.

## [1.4.0] - 2026-05-04

### Added
- Skip reconciliation for a volume by setting the `piraeus.io/skip-affinity-controller` annotation on the PV or the `Aux/affinity-updater-skip` property on the LINSTOR ResourceDefinition.
...
[Unreleased]: https://github.com/piraeusdatastore/linstor-affinity-controller/compare/v1.4.0...HEAD
